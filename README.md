...
Anything not supported right now will **_NEVER_** be supported, TrollStore is a one time thing, it will not receive compatibility updates in the future, please **stop asking** about it, GitHub issues regarding version support will be **closed without answer**.
...
Please refer to "Compatibility" above to check whether your version is compatible, if it's not then these links will not work.
